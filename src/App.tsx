...
function App() {
  ...
  return (
    <div className='bg-zinc-black flex min-h-screen grow flex-1 flex-col'>
      <div className='z-10'>
        <div className='duration-300 h-full grow  gap-4 flex flex-1 items-center justify-center flex-col mx-auto bg-neutral-950 dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]   bg-[radial-gradient(100%_50%_at_50%_0%,rgba(0,163,255,0.13)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]'>
